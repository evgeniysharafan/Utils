...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect rect, View v, RecyclerView parent, RecyclerView.State state) {
        ...
        if (mShowLastDivider || position < (parent.getAdapter().getItemCount() - 1)) {
            ...
            if (mPaintProvider != null) {
                if (mColorProvider != null) {
                    throw new IllegalArgumentException(
                            "Use setColor method of Paint class to specify line color. " +
                                    "Do not provider ColorProvider if you set PaintProvider.");
                }
                if (mSizeProvider != null) {
                    throw new IllegalArgumentException(
                            "Use setStrokeWidth method of Paint class to specify line size. " +
                                    "Do not provider SizeProvider if you set PaintProvider.");
                }
            }
        }
    }
